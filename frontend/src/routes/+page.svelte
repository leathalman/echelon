...
<div class="flex flex-col basis-[75%] justify-center items-center space-y-7">
	...
	<div
		class="w-[80%] md:max-w-176 h-28 flex flex-col items-center rounded-md border focus-within:ring-ring focus-within:ring-2 focus-within:ring-offset-2 focus-within:ring-offset-background">
