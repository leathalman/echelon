...
use crate::api::conversationsSvelte::{conversation_list_handler, conversation_list_messages, conversation_new_handler, conversation_new_message_handler};
...
pub fn create_router(app_state: Arc<AppState>) -> Router {
    ...
    let protected_routes = Router::new()
        .route("/conversationsSvelte", get(conversation_list_handler).post(conversation_new_handler))
        .route(
            "/conversationsSvelte/:conversation_id/messages",
